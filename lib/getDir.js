...
function parseLinks(dir, dirDepth){
  ...
  try {
    ...
    if (dirDepth > 0){
      mdLinks += '<a href="#" id="go_back" title="Go Back"><i class="fa fa-arrow-left"></i></a>';
    } else {
      mdLinks += '<a href="#" id="go_back_inactive" title="Go Back"><i class="fa fa-arrow-left"></i></a>';
    }
    mdLinks += '<a href="#" id="new_folder" title="New Folder"><i class="fa fa-folder"></i></a>';
    mdLinks += '<a href="#" id="new_file" title="New File"><i class="fa fa-file"></i></a>';
    mdLinks += '</div>';
